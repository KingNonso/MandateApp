            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="church" class="col-md-4 col-form-label text-md-right">{{ __('Church Number') }}</label>

                            <div class="col-md-6">
                                <input id="church" type="text" class="form-control{{ $errors->has('church') ? ' is-invalid' : '' }}" name="church" value="{{ old('church') }}"  autofocus>
